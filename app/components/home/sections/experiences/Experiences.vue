...
<template>
  <section class="experiences">
    ...
    <div class="experiences__bg-mask"></div>
    <div class="experiences__container">
      <div class="experiences__content">
        ...
        <div class="timeline">
          ...
          <div v-for="(exp, index) in experiences" :key="exp.company" class="timeline__item"
            :class="{ 'timeline__item--left': index % 2 === 0, 'timeline__item--right': index % 2 !== 0 }">
            <div class="timeline__dot"></div>

            <ExperienceCard :company="exp.company" :role="exp.role" :period="exp.period" :location="exp.location"
              :logo="exp.logo" :bullets="exp.achievements" />
          </div>
        </div>
